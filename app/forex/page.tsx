        ...
        <div className="min-h-screen gradient-bg">
            ...
            <main className="lg:ml-64 min-h-screen p-4 sm:p-6 lg:p-10">
                ...
                <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
                    <div>
                        <h1 className="text-xl sm:text-2xl font-semibold text-white tracking-tight">USD/JPY</h1>
                        ...
                        <div className="panel rounded-xl p-3 sm:p-4">
                            <div className="flex items-center justify-between mb-3 sm:mb-4">
                                <div className="flex items-center gap-2 sm:gap-3">
                                    <div className="text-sm sm:text-base font-semibold text-white tracking-tight">USD/JPY</div>
